...
type Enum_public_genre = 'Action' | 'Action & Adventure' | 'Adventure' | 'Animation' | 'Comedy' | 'Crime' | 'Documentary' | 'Drama' | 'Family' | 'Fantasy' | 'History' | 'Horror' | 'Kids' | 'Music' | 'Mystery' | 'News' | 'Reality' | 'Romance' | 'Sci-Fi & Fantasy' | 'Science Fiction' | 'Soap' | 'Talk' | 'TV Movie' | 'Thriller' | 'War' | 'War & Politics' | 'Western' | 'Unknown';
type Enum_public_media_type = 'movie' | 'tv' | 'anime';
interface Table_public_titles {
  "id": number;
  "tmdbId": string;
  "tmdbPosterPath": string;
  "tmdbOverview": string;
  "name": string;
  "genre": Enum_public_genre;
  "mediaType": Enum_public_media_type;
  "dateAdded": string;
  "isWatched": boolean;
...
interface Table_public_titles_to_users {
  "title_id": number;
  "user_id": number;
}
...
interface Schema_public {
  "titles": Table_public_titles;
  "titles_to_users": Table_public_titles_to_users;
