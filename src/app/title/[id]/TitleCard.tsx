    ...
    <Card>
      ...
      <CardContent className="flex flex-col space-y-5">
        ...
        <div className="mb-5 flex flex-col space-y-5">
          <div className="flex flex-col justify-center space-y-2">
            <h5 className="text-muted-foreground text-center underline underline-offset-4">
              Overview
            </h5>
          ...
          <div className="flex flex-row justify-between space-x-5">
            <div className="flex flex-col">
              ...
              <span>{data.dateAdded.toString()}</span>
            </div>
            <div className="flex flex-col items-center space-y-2">
              {/*TODO: Implement this for mobile: https://ui.shadcn.com/docs/components/drawer (Use drawer for mobile and dialog for desktop*/}
              {userData && (
                <ToggleWatched
                  titleId={data.id}
